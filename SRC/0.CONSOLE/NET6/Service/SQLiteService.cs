...
using NET6.Service.Model.Dto;
using System;
using System.Data.Common;
using NET6.Repository.Entities;
using Microsoft.Extensions.DependencyInjection;
using Microsoft.Extensions.Hosting;
using Npgsql;
using Microsoft.Data.Sqlite;

namespace NET6.Service
{
    public class SQLiteService : IService<TestTable1Dto>
    {
        ...
        public SQLiteService()
        {
            ...
            {
                DataSource = "D:\\DESARROLLO\\PROYECTOS\\JGACODETEST\\VS2K22\\VS2K22\\SRC\\0.CONSOLE\\NET6\\Repository\\SQLite\\TESTSQLITEDB.sqlite",
                Pooling = true
            };
        }
